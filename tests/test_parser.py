from src.mcfg_parser_aditya_dan.parser import *
...
class TestParser:
    ...
    test_object = Parser(MCFG_rules)
    test_sentence = ['who', 'does', 'the', 'greyhound', 'believe']

    def test_object_creation(self):
        assert isinstance(self.test_object, Parser)

    def test_parser(self):
        assert self.test_object.parse(self.test_sentence) == [MCFGRuleElementInstance('S', (0, 5,))]
